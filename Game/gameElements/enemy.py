...
class Enemy(Unit):
    ...
    def __init__(self, x, y, w, h, img_name, description, hp, attack, defense,
                skill, speed, xp, movement, AITYPE, isEnemy = True):
        super().__init__(x, y, w, h, img_name, description, hp, attack, defense,
                         skill, speed, xp, movement)
        self.isEnemy = True
        self.AIType = AITYPE
